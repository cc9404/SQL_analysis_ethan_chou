...
| **3** | [Analyzing Repeat Channel Behavior](./03_analyzing_repeat_channel_behavior) | [`analyzing_repeat_channel_behavior.sql`](./03_analyzing_repeat_channel_behavior/analyzing_repeat_channel_behavior.sql) | [`CSV`](./03_analyzing_repeat_channel_behavior/final_output.csv) | Compare acquisition channels for new vs. repeat sessions to understand how returning traffic is driven (organic, direct, brand, social). |
| **4** | [Analyzing New and Repeat Conversion Rates](./04_analyzing_new_and_repeat_conversion_rates) | [`analyzing_new_and_repeat_conversion_rates.sql`](./04_analyzing_new_and_repeat_conversion_rates/analyzing_new_and_repeat_conversion_rates.sql) | [`CSV`](./04_analyzing_new_and_repeat_conversion_rates/final_output.csv) | Compare session volume, conversion rate, and revenue per session (RPS) between new and repeat sessions. |
