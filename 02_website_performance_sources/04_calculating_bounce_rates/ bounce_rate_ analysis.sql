...
-- next, we'll bring in the landing page, but retrict to home only
...
/* NEXT STEPS
1. keep an eye on bounce rates, which represent a mojor area of improvement
2. measure a new page that will improve performance and analyze the results of an A/B split test against the homepage
