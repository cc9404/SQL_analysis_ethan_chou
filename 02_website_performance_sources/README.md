...
| **2** | [Finding Most Viewed Website Pages](./02_finding_most_viewed_website_pages) | [`finding_most_viewed_website_pages.sql`](./02_finding_most_viewed_website_pages/finding_most_viewed_website_pages.sql) | [`CSV`](./02_finding_most_viewed_website_pages/finding_most_viewed_website_pages.csv) | Rank most-frequently visited website pages by total pageview volume prior to mid-June 2012.[cite: 7] |
| **3** | [Finding Top Entry Pages](./03_finding_top_entry_pages) | [`finding_top_entry_pages.sql`](./03_finding_top_entry_pages/finding_top_entry_pages.sql) | [`CSV`](./03_finding_top_entry_pages/finding_top_entry_pages.csv) | Determine primary entry points across all sessions to evaluate homepage traffic exposure.[cite: 8] |
