...
| **5** | [Analyzing Direct Traffic](./05_analyzing_direct_traffic) | [`analyzing_direct_traffic.sql`](./05_analyzing_direct_traffic/analyzing_direct_traffic.sql) | [`CSV`](./05_analyzing_direct_traffic/final_output.csv) | Evaluate monthly traffic volume for Organic Search, Direct Type-in, and Paid Brand Search relative to Paid Nonbrand sessions to track brand equity growth. |
