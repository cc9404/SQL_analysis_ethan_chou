...
| **3** | [Traffic Sources Overview](./03_traffic_sources_analysis/) | [`traffic_sources_analysis.sql`](./03_traffic_sources_analysis/01_traffic_sources_analysis.sql) | [`CSV`](./03_traffic_sources_analysis/analyzing_top_traffic_sources.csv) | High-level evaluation of traffic providers, referrer domains, and session distribution. |
