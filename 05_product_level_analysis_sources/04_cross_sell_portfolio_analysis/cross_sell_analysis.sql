...
to see CTR from the /cart page, Avg Products per Order, AOV, and overall revenue per /cart page
view
*/
...
-- STEP 3: Find the orders. associated with /cart sessions. Analyze products purchased, AOV
-- STEP 4 and final output: Aggregate and analyze a summary of our findings
...
-- final_output -- turn it into subquery 
SELECT
	time_period,
